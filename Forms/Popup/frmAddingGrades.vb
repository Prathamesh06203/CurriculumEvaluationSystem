                ...
                For Each prerequisite As String In subj
                    ...
                    Select Case lblGrades.Text
                        ...
                        Case "dtgFirstYearSecond"
                            sql = "SELECT * FROM `tblgrades` g, `tblsubject` s WHERE g.`SubjectId`=s.`SubjectId`  AND IdNo = " & lblidno.Text & " AND UPPER(Subject) in ('" & prerequisite & "') AND Grades = 0 OR Grades > 3"
                            reloadtxt(sql)
